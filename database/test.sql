...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 30, 2020 at 07:00 AM
...
INSERT INTO `companies` (`id`, `name`, `owner`, `partners`) VALUES
(1, 'Big basket', 'SRK', '');
...
INSERT INTO `departments` (`id`, `department_name`, `location_id`) VALUES
...
INSERT INTO `dependents` (`id`, `first_name`, `last_name`, `relationship`, `employee_id`) VALUES
...
INSERT INTO `employees` (`id`, `first_name`, `last_name`, `email`, `phone_number`, `hire_date`, `job_id`, `salary`, `manager_id`, `department_id`) VALUES
...
INSERT INTO `logs` (`id`, `partner`, `data`, `time`) VALUES
(1, 'B', '{\"table\":\"employees\"}', '2020-07-27 22:41:20'),
(2, 'B', '{\"table\":\"employees\"}', '2020-07-28 22:43:24'),
(3, 'A', '{\"table\":\"employees\"}', '2020-07-28 22:56:41'),
(4, 'A', '{\"table\":\"employees\"}', '2020-07-28 22:57:46'),
(5, 'A', '{\"table\":\"employees\"}', '2020-07-28 22:59:24'),
(6, 'A', '{\"table\":\"employees\"}', '2020-07-28 23:00:30'),
(7, 'A', '{\"table\":\"employees\"}', '2020-07-28 23:00:31'),
(8, 'A', '{\"id\":\"100\",\"table\":\"employees\"}', '2020-07-28 23:00:42'),
(9, 'A', '{\"id\":\"100\",\"table\":\"employees\"}', '2020-07-28 23:00:53'),
(10, 'A', '{\"table\":\"employees\"}', '2020-07-28 23:01:00'),
(11, 'A', '{\"table\":\"employees\"}', '2020-07-28 23:05:49'),
(12, 'A', '{\"table\":\"employees\"}', '2020-07-28 23:06:09'),
(13, 'A', '{\"table\":\"employees\"}', '2020-07-29 00:52:59'),
(14, 'A', '{\"table\":\"employees\"}', '2020-07-29 00:53:15'),
(15, 'A', '{\"table\":\"employees\"}', '2020-07-29 00:53:44'),
(16, 'A', '{\"table\":\"employees\"}', '2020-07-29 00:53:49'),
(17, 'A', '{\"table\":\"employees\"}', '2020-07-29 00:53:54'),
(18, 'A', '{\"table\":\"employees\"}', '2020-07-29 00:55:35'),
(19, 'A', '{\"table\":\"employees\"}', '2020-07-29 00:55:36'),
(20, 'A', '{\"table\":\"employees\"}', '2020-07-29 00:55:43'),
(21, 'A', '{\"table\":\"employees\"}', '2020-07-29 01:04:54'),
(22, 'A', '{\"table\":\"employees\"}', '2020-07-29 01:18:10'),
(23, 'A', '{\"table\":\"employees\"}', '2020-07-29 01:18:27'),
(24, 'A', '{\"table\":\"employees\"}', '2020-07-29 01:25:16');
...
--
ALTER TABLE `departments`
  ADD CONSTRAINT `departments_ibfk_1` FOREIGN KEY (`location_id`) REFERENCES `locations` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `dependents`
--
ALTER TABLE `dependents`
  ADD CONSTRAINT `dependents_ibfk_1` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `employees`
  ...
  ADD CONSTRAINT `employees_ibfk_2` FOREIGN KEY (`department_id`) REFERENCES `departments` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `locations`
  ADD CONSTRAINT `locations_ibfk_1` FOREIGN KEY (`country_id`) REFERENCES `countries` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
